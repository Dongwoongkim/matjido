...
public class RestaurantExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCategoryDepthExceededException(RuntimeException e) {
        return ErrorResponseUtil.getResponse(e, HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler
    public ResponseEntity<ErrorResponse> handleInvalidAddressFormatException(InvalidAddressFormatException e) {
        return ErrorResponseUtil.getResponse(e, HttpStatus.BAD_REQUEST);
    }
